...
- [x] WebRTCTransport
- [x] GUI: офлайн-сигналинг (Offer)
- [ ] GUI: Answer, 
- [ ] GUI: индикатор ICE
- [ ] Логика fallback к TCP
- [ ] Тест-кнопка «ICE connected?» с логом статусов
- [ ] Тестирование разных NAT/CGNAT сценариев
- [ ] GUI: у нас сейчас все элементы добавляются вертикально, но нет прокрутки, а вообще можно было бы разместить все более компактно например в два столбца по смыслу, ну или скрол
- [ ]