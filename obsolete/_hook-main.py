...
hiddenimports = (
    ...
    collect_submodules('providers.animedia.v0.models') +
    collect_submodules('providers.animedia.v0.adapter') +
    collect_submodules('providers.animedia.v0.service') +
    collect_submodules('providers.animedia.v0.repository') +
    collect_submodules('providers.animedia.v0.client') +
    collect_submodules('providers.animedia.v0.transport') +
    collect_submodules('providers.animedia.v0.parser') +
    collect_submodules('providers.animedia.v0.cache_manager') +
    collect_submodules('providers.animedia.v0.legacy_mapper') +
    collect_submodules('providers.animedia.v0.retry_manager') +
    collect_submodules('providers.animedia.v0.factory') +
